class CfgPatches
{
    class fza_ah64e_controls
    {
        ...
        requiredAddons[] = {"fza_ah64_controls", "fza_ah64_sfmplus", "fza_ah64_common", "fza_ah64_aiCrew", "fza_ah64_audio", "fza_ah64_ihadss", "fza_ah64_fcr", "fza_ah64_ase", "cba_main", "cba_xeh"};
        version = 1.0.0;
        versionStr = "1.0.0";
        versionAr[] = {1, 0, 0};
    };
